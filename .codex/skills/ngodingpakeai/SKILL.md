...
- Workspace ID: `ee45a314-a996-48a6-a2f3-98b67a8304c1`
- An access token starting with `ngpk_`. Provide it via the `NGODINGPAKEAI_TOKEN`
  ...
  Create one at https://www.ngodingpakeai.com/settings (API keys). Synced content is viewable at https://www.ngodingpakeai.com/workspace/ee45a314-a996-48a6-a2f3-98b67a8304c1.
...
2. `npx ngodingpakeai connect --workspace ee45a314-a996-48a6-a2f3-98b67a8304c1 --token "$NGODINGPAKEAI_TOKEN"` — link this repo to the workspace (first time only).
...
5. Always report the sync summary and https://www.ngodingpakeai.com/workspace/ee45a314-a996-48a6-a2f3-98b67a8304c1. Only pass on links the CLI actually printed — never assemble one from an id yourself.
